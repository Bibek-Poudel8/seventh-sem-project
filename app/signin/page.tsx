      ...
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8 gap-3">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-slate-400 mt-1">Sign in to your FinanceAI account</p>
          </div>
        </div>

        <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-8 shadow-2xl">
          {registered && (
            <div className="mb-5 rounded-lg bg-emerald-500/15 border border-emerald-500/30 px-4 py-3 text-sm text-emerald-400">
