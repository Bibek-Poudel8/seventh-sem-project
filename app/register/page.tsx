...
import { register, AuthState } from "@/app/actions/auth.actions";
          ...
          <form action={action} className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                disabled={pending}
                className="bg-white/10 border-white/20 text-white placeholder:text-slate-500 focus:border-indigo-400 focus:ring-indigo-400/20"
              />
              {state?.errors?.name && (
