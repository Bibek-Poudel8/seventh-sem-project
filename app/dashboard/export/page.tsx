      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base flex items-center gap-2">
            <FontAwesomeIcon icon={faFileLines} className="h-4 w-4" /> Export Transactions
          </CardTitle>
        ...
        <CardContent className="flex gap-3">
          <a href="/api/export/csv" download>
            <Button className="gap-1.5"><FontAwesomeIcon icon={faDownload} className="h-3.5 w-3.5" /> Export All (CSV)</Button>
          </a>
        </CardContent>
      </Card>
    </div>
